...
var CmdNew = &cobra.Command{
	...
	Long:  "Create a service project using the repository template. Example: Next new helloworld",
	Run:   run,
}
...
func init() {
	if repoURL = os.Getenv("NEXT_LAYOUT_REPO"); repoURL == "" {
		repoURL = "https://github.com/nextmicro/next-layout.git"
	}
	timeout = "60s"
