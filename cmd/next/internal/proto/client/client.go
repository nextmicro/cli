...
var CmdClient = &cobra.Command{
	...
	Long:  "Generate the proto client code. Example: next proto client helloworld.proto",
	Run:   run,
}
...
func init() {
	if protoPath = os.Getenv("NEXT_PROTO_PATH"); protoPath == "" {
...
func generate(proto string, args []string) error {
	...
	inputExt := []string{
		"--proto_path=" + base.NextMod(),
		"--proto_path=" + filepath.Join(base.NextMod(), "third_party"),
