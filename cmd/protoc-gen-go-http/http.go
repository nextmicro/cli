...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/nextmicro/next/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/nextmicro/next/transport/http/binding")
)

var methodSets = make(map[string]int)

// generateFile generates a _http.pb.go file containing nextmicro errors definitions.
...
// generateFileContent generates the nextmicro errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool, omitemptyPrefix string) {
	...
	g.P("// is compatible with the nextmicro package it is being compiled against.")
